...
const STATUS_STYLES: Record<string, { label: string; className: string }> = {
  completed: { label: "Completed", className: "bg-tertiary/10 text-tertiary" },
  pending:   { label: "Pending",   className: "bg-accent-saffron/15 text-amber-700"     },
  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="col-span-2 bg-linear-to-br from-tertiary/8 to-tertiary/3 border border-tertiary/15 rounded-2xl p-5 shadow-sm">
          <p className="text-[10px] font-bold text-tertiary/70 uppercase tracking-widest mb-1.5">Completed Revenue</p>
        ...
        <div className="bg-surface-container-lowest border border-black/6 rounded-2xl p-5">
          ...
          <p className="text-3xl font-extrabold font-headline text-on-surface">{rows.length}</p>
        </div>
        <div className="bg-surface-container-lowest border border-black/6 rounded-2xl p-5">
