        ...
        return (
          <div className={`w-full h-full relative overflow-hidden flex flex-col items-center justify-between ${isA4 ? 'p-16' : 'p-8'} text-center bg-black`}>
            ...
            <div className="relative group z-10">
              ...
              <div className="absolute -top-4 -left-4 w-12 h-12 border-t-[8px] border-l-[8px] border-white rounded-tl-2xl opacity-80" />
              <div className="absolute -top-4 -right-4 w-12 h-12 border-t-[8px] border-r-[8px] border-white rounded-tr-2xl opacity-80" />
              <div className="absolute -bottom-4 -left-4 w-12 h-12 border-b-[8px] border-l-[8px] border-white rounded-bl-2xl opacity-80" />
              <div className="absolute -bottom-4 -right-4 w-12 h-12 border-b-[8px] border-r-[8px] border-white rounded-br-2xl opacity-80" />
              
              <div className={`${isA4 ? 'p-10' : 'p-5'} bg-white/95 backdrop-blur-2xl rounded-[3rem] shadow-[0_0_100px_rgba(255,255,255,0.2)]`}>
                <QRCodeSVG
                  value={url}
                  size={isA4 ? 380 : 150}
                  fgColor={qrColor}
          ...
          <div className="w-full h-full bg-surface-container-lowest flex flex-col items-center justify-center p-12 relative overflow-hidden" style={{ color: textColor }}>
            ...
            <div className="flex flex-col items-center gap-8 w-full">
              ...
              <div className="relative">
                ...
                <div className="relative bg-white p-14 rounded-[4rem] shadow-xl border border-surface-container/50">
                  <QRCodeSVG
                    value={url}
                    size={isA4 ? 400 : 160}
                    fgColor={qrColor}
