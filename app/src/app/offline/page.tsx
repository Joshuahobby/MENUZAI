  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center px-6 text-center">
      <div className="max-w-sm">
        ...
        <h1 className="text-2xl font-[var(--font-headline)] font-extrabold mb-3">You&apos;re offline</h1>
        ...
        <button
          ...
          className="px-8 py-3 bg-primary-container text-white font-bold rounded-xl hover:opacity-90 transition-all active:scale-95"
        >
          Try Again
        </button>
      </div>
